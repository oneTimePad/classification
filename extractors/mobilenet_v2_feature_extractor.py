...
class MobileNetV2FeatureExtractor(feature_extractor.FeatureExtractor):
	...
	def predict(self,preprocessed_inputs):
		...
		with tf.contrib.slim.arg_scope(mobilenet_v2.training_scope(is_training=self._is_training)):
			_, end_points = mobilenet_v2.mobilenet(preprocessed_inputs, reuse=self._reuse)
